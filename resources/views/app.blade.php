...
<head>
    ...
    <script>
        (adsbygoogle = window.adsbygoogle || []).push({
            google_ad_client: "ca-pub-1983162371188961",
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" style="">
                            <div style="position: relative; line-height: 0;">
                                ...
                                <div class="user-clicks" style="padding-left: 50px; line-height: 1; font-size: 12px; display: inline-block">Клики: {{Auth::user()->clicks}}</div>
                                <div class="user-clicks" style="padding-left: 10px; font-size: 12px; line-height: 1; display: inline-block">Кристаллы: {{Auth::user()->crystals}}</div>
                            </div>    
                        </a>
