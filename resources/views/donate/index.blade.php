...
@section('content')
    <div>
        ...
        <p>Так как Кристаллы можно <a href="{{ url('exchange') }}">менять на Клики</a>, то это очень ценный ресурс в рамках нашего проекта. Клики бывают нужны срочно по разным причинам: купить сертификат Торговца, скорее забрать предмет из магазина на который кто-то еще претендует и т.д., с дополнительными Кристаллами на счету всегда будет легче активным пользователям сайта. В дальнейшем, участники смогут сами создавать раздачи за Кристаллы и начнут зарабатывать их без вложений каких либо денег. Участники элитных раздач также имеют свою выгоду: участвуя в раздаче игр или предметов стоимостью от 500 рублей, стоимость входа в раздачу будет составлять от 1 Кристалла (в зависимости от условий раздачи), выиграв игру/предмет таким способом, покупатель потратит всего лишь 15 рублей вместо полной стоимости игры.</p>

        <h1>Обменять Клики на Кристаллы</h1>
        <div class="crystals-list row">
            <div class="col-sm-4">
