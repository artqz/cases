...
<div class="container">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form class="form-horizontal" role="form" method="POST" action="{{ url('/discuss/channels/'. $slug_channel .'/'.$slug_theme.'/edit-theme') }}">
                {{ csrf_field() }}
                ...
                <div class="form-group">
                    <div class="col-md-6 col-md-offset-4">
                        ...
                        <a href="{{ url('/discuss/channels/'. $slug_channel .'/'.$slug_theme.'/delete-theme') }}" type="submit" class="btn btn-danger">
                            Удалить
                        </a>
                    </div>
                </div>
