...
@section('content')
    ...
    Если выбирается Предмет, вечером этого же дня, Мы со своего аккаунта в Steam'е (ник - <strong>djoctuk</strong>, да простит нас Бог, за такой ник) предложим обмен Вашему аккаунту в Steam'е.
