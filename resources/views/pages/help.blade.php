...
@section('content')
    ...
    Для того чтобы получить купленный предмет, необходимо добавить в своём профиле ссылку для обмена! <a href="https://steamclicks.ru/discuss/channels/novosti/ssylka-na-obmen-gde-vzyat">Здесь можно почитать где её взять</a>. Предметы выдаются в ручном режиме после 21:00 (Мск)!
    <br><br>
