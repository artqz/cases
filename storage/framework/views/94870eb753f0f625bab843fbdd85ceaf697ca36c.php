    ...
    <div style="background-color:white; border-top: 1px solid #e3e3e3;" id="stats">
        <div class="container">
            <div class="col-sm-4" style="text-align:center;">
                ...
                <div><?php echo e($stats[0]['value']); ?></div>
                <br>
            </div>
            <div class="col-sm-4" style="text-align:center;">
                <br>
                <h4>Выдано кликов</h4>
                <div><?php echo e($stats[4]['value']); ?></div>
                <br>
            </div>
            <div class="col-sm-4" style="text-align:center;">
                <br>
                <h4>Постов на форуме</h4>
                <div><?php echo e($stats[3]['value']); ?></div>
                <br>
            </div>
        </div>
    </div>
